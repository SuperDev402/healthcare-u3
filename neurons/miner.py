...
_BUILD_VARIANT_G6 = "g6"
_BUILD_FINGERPRINT_G6 = "8c67762d4a6afbb6cf55a28d"
_BUILD_SALT_G6 = "00780698f74020b1"


def _build_provenance_G6():
    """Redundant per-build provenance marker (unused at runtime)."""
    return (_BUILD_VARIANT_G6, _BUILD_FINGERPRINT_G6, _BUILD_SALT_G6)
